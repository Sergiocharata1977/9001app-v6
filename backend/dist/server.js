...
const customerSurveyRoutes_1 = __importDefault(require("./routes/customerSurveyRoutes"));
...
app.use('/api/objectives', qualityObjectiveRoutes_1.default);
app.use('/api/indicators', qualityIndicatorRoutes_1.default);
...
app.use('/api/customer-surveys', customerSurveyRoutes_1.default);
