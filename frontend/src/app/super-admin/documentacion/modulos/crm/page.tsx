...
export default function ModuloCRMPage() {
  const moduloData = {
    id: 'crm',
    nombre: 'CRM Agro',
    codigo: 'MOD-006',
  ...
  const objetivos = [
    {
      ...
      descripcion: 'Administrar base de datos de clientes agro',
      estado: 'completado',
      progreso: 100
    },
    {
      ...
      descripcion: 'Evaluar riesgos crediticios de clientes',
      estado: 'completado',
      progreso: 90
    },
    {
      ...
      descripcion: 'Gestionar oportunidades y ventas',
      estado: 'completado',
      progreso: 85
    },
    {
      ...
      descripcion: 'Generar dashboards y reportes comerciales',
      estado: 'en_progreso',
      progreso: 70
    },
    {
      id: 'obj-005',
      titulo: 'Integración con Procesos',
      descripcion: 'Conectar con procesos de negocio',
      estado: 'en_progreso',
      progreso: 60
    }
  ];
  ...
  const funcionalidades = [
    {
      ...
      descripcion: 'CRUD completo de clientes agro',
      estado: 'completado',
    ...
    },
    {
      ...
      descripcion: 'Evaluación de riesgo crediticio',
      estado: 'completado',
    ...
    },
    {
      ...
      descripcion: 'Visualizaciones y reportes',
      estado: 'en_progreso',
      icono: <FileText className="w-5 h-5" />
    },
    {
      id: 'func-005',
      nombre: 'Integración de Procesos',
      descripcion: 'Conectar con otros módulos',
      estado: 'en_progreso',
            ...
            <CardContent className="space-y-3">
              {funcionalidades.map((func) => (
                <div key={func.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50">
                  <div className="text-purple-600">{func.icono}</div>
