...
export default function ModuloProcesosPage() {
  const moduloData = {
    id: 'procesos',
  ...
  const objetivos = [
    {
      id: 'obj-001',
      titulo: 'Definir y documentar procesos críticos',
      descripcion: 'Identificar y documentar todos los procesos críticos del negocio según ISO 9001',
      estado: 'completado',
      progreso: 100
    },
    {
      id: 'obj-002',
      titulo: 'Implementar flujos de trabajo',
      descripcion: 'Crear flujos de trabajo automatizados para cada proceso',
      estado: 'en_progreso',
      progreso: 75
    },
    {
      id: 'obj-003',
      titulo: 'Establecer indicadores de proceso',
      descripcion: 'Definir KPIs y métricas para medir la eficiencia de cada proceso',
      estado: 'en_progreso',
      progreso: 60
    },
    {
      ...
      descripcion: 'Entrenar al equipo en el uso de los nuevos procesos',
      estado: 'pendiente',
      progreso: 25
    },
    {
      id: 'obj-005',
      titulo: 'Implementar mejora continua',
      descripcion: 'Establecer ciclo de revisión y mejora de procesos',
      estado: 'pendiente',
      progreso: 10
    }
  ];
  ...
  const funcionalidades = [
    {
      ...
      descripcion: 'Crear y configurar nuevos procesos del negocio',
      estado: 'completado',
    ...
    },
    {
      ...
      descripcion: 'Diseñar y ejecutar flujos automatizados',
      estado: 'completado',
      icono: <Workflow className="w-5 h-5" />
    },
    {
      id: 'func-003',
      nombre: 'Registros de Proceso',
      descripcion: 'Capturar y gestionar registros de ejecución',
      estado: 'completado',
      icono: <FileText className="w-5 h-5" />
    },
    {
      id: 'func-004',
      nombre: 'Indicadores de Rendimiento',
      descripcion: 'Monitorear KPIs y métricas de proceso',
      estado: 'en_progreso',
      icono: <BarChart3 className="w-5 h-5" />
    },
    {
      id: 'func-005',
      nombre: 'Gestión de Responsables',
      descripcion: 'Asignar y gestionar responsables de proceso',
      estado: 'pendiente',
