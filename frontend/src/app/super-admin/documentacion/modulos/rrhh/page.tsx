...
export default function ModuloRRHHPage() {
  const moduloData = {
    id: 'rrhh',
  ...
  const objetivos = [
    {
      ...
      descripcion: 'Administrar empleados, contratos y datos personales',
      estado: 'completado',
      progreso: 100
    },
    {
      ...
      descripcion: 'Definir departamentos, puestos y jerarquías',
      estado: 'completado',
      progreso: 100
    },
    {
      ...
      descripcion: 'Evaluar y desarrollar competencias del personal',
      estado: 'completado',
      progreso: 90
    },
    {
      ...
      descripcion: 'Planificar y gestionar programas de capacitación',
      estado: 'en_progreso',
      progreso: 75
    },
    {
      ...
      descripcion: 'Implementar sistema de evaluación de desempeño',
      estado: 'en_progreso',
      progreso: 60
    }
  ];
  ...
  const funcionalidades = [
    {
      ...
      descripcion: 'CRUD completo de empleados y datos',
      estado: 'completado',
    ...
    },
    {
      ...
      descripcion: 'Definición de roles y responsabilidades',
      estado: 'completado',
    ...
    {
      id: 'func-005',
      nombre: 'Análisis de Riesgos RRHH',
      descripcion: 'Identificación y gestión de riesgos laborales',
      estado: 'en_progreso',
