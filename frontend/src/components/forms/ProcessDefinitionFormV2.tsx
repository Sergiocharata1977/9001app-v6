...
export function ProcessDefinitionFormV2({
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          >
            ...
            {isLoading ? 'Guardando...' : mode === 'create' ? 'Crear Proceso' : 'Actualizar Proceso'}
          </Button>
        </div>
      </form>
    </Form>
  ...
  // Renderizar como modal o como card
  if (mode === 'create') {
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Crear Nueva Definición de Proceso</DialogTitle>
            <DialogDescription>
              Complete la información para crear una nueva definición de proceso ISO 9001.
            </DialogDescription>
          </DialogHeader>
          <FormContent />
        </DialogContent>
  ...
  // Modo edición - renderizar como card
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle>
          {mode === 'edit' ? 'Editar Definición de Proceso' : 'Nueva Definición de Proceso'}
        </CardTitle>
        <CardDescription>
          Complete la información para {mode === 'edit' ? 'actualizar' : 'crear'} la definición de proceso ISO 9001.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <FormContent />
